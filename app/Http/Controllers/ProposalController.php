...
{
    // View public events to propose components
    ...
    public function store(Request $request, Event $event)
    {
        ...
        DB::beginTransaction();
        try {
            // Create the component with initial "proposed" status
            ...
            return redirect()->route('proposals.my-proposals')
                ->with('success', 'Proposal successfully submitted. The organizer will review it soon.');
